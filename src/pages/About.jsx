  ...
  return (
    <div>
      <main className="bg-white block">
        {/* first section */}
        <section className="bg-[url('../../public/images/forests-main.png')] bg-center bg-no-repeat bg-cover w-full text-white mb-16">
          <div className="flex flex-col sm:flex-row mx-auto px-4 sm:px-0 text-white">
            ...
            <div className="px-[4%] py-[40px] text-center flex-1">
              ...
              <div className="bg-[url('../../public/images/results-tree.78168e82.png')] bg-top bg-no-repeat bg-contain h-[200px] mx-auto mb-4 w-[250px] sm:w-[300px] relative text-center">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 mb-16 place-items-center">
              ...
              <div className="text-center max-w-[250px]">
                <img src="../../public/images/cow.png" alt="animal" className="mx-auto h-20 w-20 mb-3" />
              ...
              {/* Tip 2 */}
              <div className="text-center max-w-[250px]">
                <img src="../../public/images/mail.png" alt="animal" className="mx-auto h-20 w-20 mb-3" />
              ...
              {/* Tip 3 */}
              <div className="text-center max-w-[250px]">
                <img src="../../public/images/clothes.png" alt="animal" className="mx-auto h-20 w-20 mb-3" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 mb-16 place-items-center">
              {/* Tip 4 */}
              <div className="text-center max-w-[250px]">
                <img src="../../public/images/tyre.png" alt="animal" className="mx-auto h-20 w-20 mb-3" />
              ...
              {/* Tip 5 */}
              <div className="text-center max-w-[250px]">
                <img src="../../public/images/thermostat.png" alt="animal" className="mx-auto h-20 w-20 mb-3" />
              ...
              {/* Tip 6 */}
              <div className="text-center max-w-[250px]">
                <img src="../../public/images/fuel.png" alt="animal" className="mx-auto h-20 w-20 mb-3" />
        ...
        <section className="bg-white">
          <div className="bg-[#1a5eab] relative">
            <img src="../../public/images/plant.avif" alt="green-field" className="w-full" />
          </div>
        </section>
      </main>
    </div>
